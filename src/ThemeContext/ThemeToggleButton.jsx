...
const ThemeToggleButton = () => {
  ...
  return (
      <label htmlFor="theme-switch" className="relative cursor-pointer">
        ...
        <span className="block h-7 w-12 rounded-full border border-gray-950/5 bg-gray-200 transition duration-300 peer-checked:border-indigo-500 peer-checked:bg-indigo-500"></span>
      </label>
  );
};
